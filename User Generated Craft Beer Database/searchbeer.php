...
<?php
if(!($stmt = $mysqli->prepare("SELECT beer.name, beer.description, beer.availability, beer.abv, style.name FROM beer INNER JOIN style ON beer.style_id = style.id WHERE beer.name = ? GROUP BY beer.name"))){
